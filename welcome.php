			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel" style="width: 50%;margin-left: 25%;">
			    ...
			    <div class="carousel-inner">
			    	<div class="item active">
			    		<img src="store_images/img4.jpg" alt="" style="width:100%;">
				    ...
				    <div class="item">
				        <img src="store_images/img2.png" alt="" style="width:100%;">
				        <div class="carousel-caption">
				        	<h3></h3>
				        	<p></p>
				        </div>
				    ...
				    <div class="item">
				        <img src="store_images/img5.png" alt="" style="width:100%;">
				        <div class="carousel-caption">
				        	<h3></h3>
				        	<p></p>
				        </div>
